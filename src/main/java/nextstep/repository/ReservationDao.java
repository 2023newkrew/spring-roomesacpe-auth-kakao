...
public class ReservationDao {
    ...
    public List<Reservation> findAllByThemeIdAndDate(Long themeId, String date) {
        String sql = "SELECT reservation.id, reservation.schedule_id, reservation.name, schedule.id, schedule.theme_id, schedule.date, schedule.time, theme.id, theme.name, theme.desc, theme.price, reservation.member_id " +
                "from reservation " +
